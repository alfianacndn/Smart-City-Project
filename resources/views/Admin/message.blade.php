                ...
                <div class="col-7 px-0">
                    <div class="px-4 py-5 chat-box bg-white">
                        ...
                        <ul class="chat-list list-style-none px-3 pt-3">
                            @foreach($d as $pesan_admin)

                            @if($pesan_admin->penerima == 'Admin' )
                            <!--chat Row -->
                            <li class="chat-item list-style-none mt-3">
                                <div class="chat-img d-inline-block">
                                </div>
                                <div class="chat-content d-inline-block pl-3">
                                    <h6 class="font-weight-medium"> {{$pesan_admin->pengirim}} </h6>
                            ...
                            <li class="chat-item odd list-style-none mt-3">
                                <div class="chat-content text-right d-inline-block pl-3">
                                    <h6 class="font-weight-medium"> for : {{$pesan_admin->penerima}} </h6>
                    ...
                    <form action="message/insert" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input name="penerima" placeholder="Penerima" class="form-control border-0" type="text">
                            <input name="pesan" placeholder="Ketik di sini" class="form-control border-0" type="text">
