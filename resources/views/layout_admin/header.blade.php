            ...
            <div class="navbar-brand">
                ...
                <a href="index.html">
                    <b class="logo-icon">
                        ...
                        <img src="../asset/images/logo2.png" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon 
                                <img src="../template1/assets/images/logo-icon.png" alt="homepage" class="light-logo" />-->
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text 
                                <img src="../template1/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                                <!-- Light Logo text 
                                <img src="../template1/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /> -->
                    </span>
                </a>
            </div>
            <!-- End Logo -->
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="assets/images/users/profile-pic.jpg" alt="Admin" class="rounded-circle" width="40">
